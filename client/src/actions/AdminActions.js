...
export const getAllJobsAdmin = () => async (dispatch) => {
    try{
        ...
        const {data} = await axios.get("https://job-orbit-mern.onrender.com/api/v1/admin/allJobs",config) ;
...
export const getAllUsersAdmin = () => async (dispatch) => {
    try{
        ...
        const {data} = await axios.get("https://job-orbit-mern.onrender.com/api/v1/admin/allUsers",config) ;
...
export const getAllAppAdmin = () => async (dispatch) => {
    try{
        ...
        const {data} = await axios.get("https://job-orbit-mern.onrender.com/api/v1/admin/allApp",config) ;
...
export const getAppData = (id) => async (dispatch) => {
    try{
        ...
        const {data} = await axios.get(`https://job-orbit-mern.onrender.com/api/v1/admin/getApplication/${id}`,config)
...
export const updateApplication = (id,dataBody) => async (dispatch) => {
    try{    
        ...
        if(dataBody.status === "not"){
         ...
         const {data} = await axios.put(`https://job-orbit-mern.onrender.com/api/v1/admin/updateApplication/${id}`,dataBody,config)
...
export const deleteApp = (id) => async (dispatch) => {
    try{
        ...
        const {data} = await axios.delete(`https://job-orbit-mern.onrender.com/api/v1/admin/deleteApplication/${id}`,config)
...
export const getUserData = (id) => async (dispatch) => {
    try{
        ...
        const {data} = await axios.get(`https://job-orbit-mern.onrender.com/api/v1/admin/getUser/${id}`,config)
...
export const updateUser = (id,userData) => async (dispatch) => {
    try{
        ...
        const {data} = await axios.put(`https://job-orbit-mern.onrender.com/api/v1/admin/updateUser/${id}`,userData,config)
...
export const deleteUser = (id) => async (dispatch) => {
    try{
        ...
        const {data} = await axios.delete(`https://job-orbit-mern.onrender.com/api/v1/admin/deleteUser/${id}`,config)
...
export const getJobData = (id) => async (dispatch) => {
    try{
        ...
        const {data} = await axios.get(`https://job-orbit-mern.onrender.com/api/v1/admin/getJob/${id}`,config) ;
...
export const updateJobData = (id,jobData) => async (dispatch) => {
    try{
        ...
        const {data} = await axios.put(`https://job-orbit-mern.onrender.com/api/v1/admin/updateJob/${id}`,jobData,config) ;
...
export const deleteJobData = (id) => async (dispatch) => {
    try{
        ...
        const {data} = await axios.delete(`https://job-orbit-mern.onrender.com/api/v1/admin/deleteJob/${id}`,config) ;
