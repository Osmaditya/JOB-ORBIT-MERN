      ...
      <div className="bg-gray-950 min-h-screen pt-14 md:px-20 px-3 text-white">
        <div className="flex flex-col gap-5 md:px-0 px-2 md:pt-8 pt-4 pb-20">
          ...
          <div>
            ...
            <Card
              title="Address"
              content="JobOrbit, Ruby Street, Bangalore, 123, Karnataka"
            />
            <Card
              title="Email"
              content={[
                "General Inquiries: info@joborbit.com",
                "Support: support@joborbit.com",
                "Job Applications: jobs@joborbit.com",
              ]}
            />
            <Card
              title="Phone"
              content={[
                "Customer Support: +914661965415",
                "HR & Job Inquiries: +1800-526-556",
              ]}
            />
